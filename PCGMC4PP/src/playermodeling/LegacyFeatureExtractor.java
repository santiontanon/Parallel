...
// */
//public class LegacyFeatureExtractor {
//
//    private static final Logger logger = LogManager.getLogger(LegacyFeatureExtractor.class);
//
...
//    };
//
//    public static HashMap< String, Double > computeFeatureVector(ArrayList<String> telemetry_at_interval,
//                                                          ArrayList<Integer> index_vector,
//                                                          HashMap<Integer, LevelData> all_persistent_data) {
//
...
//        feature_vector.replace("start_time", ((double)s_) - ((Long)all_persistent_data.get(0).data.get("start_time")).doubleValue() );
//
//        int i = 0;
...
//            }
//
//            HashMap<String, Object > persistent_data = all_persistent_data.get(index_vector.get(i)).data;
...
//                    /* This is testing */
//                    //data.replace("test_before_submit",true);
...
//                    /* This is submit */
////                    if ( (Boolean)data.get("test_before_submit") ) {
////                        analyzer.updateRuleEvidence("Testing before submitting");
////                        data.replace("test_before_submit",false);
////                    }
//
...
//                        //updateRuleEvidence("Drag objects",ruleEvidence);
//
//                        fd_coord.p1 = x_;
//                        fd_coord.p2 = y_;
//                        double dist = 0.0;
...
//                        fd_coord.reset();
//
////                        if ( (Integer)data.get("num_dragged") > 2 ) {
////                            analyzer.updateRuleEvidence("Place objects on track");
////                            //updateRuleEvidence("Place objects on the track",ruleEvidence);
////                        }
//
...
//                    //updateRuleEvidence("Remove unnecessary elements",ruleEvidence);
//                    break;
...
//                    //updateRuleEvidence("Hover over objects to see what they do",ruleEvidence);
//
//                    break;
...
//
////                    HashMap<String,String> comp_loc_map = (HashMap<String,String>) data.get("comp_loc_map");
...
////                        data.put("comp_loc_map",loc_map);
////                    } else {
////                        comp_loc_map.put(comp_id,String.format("%f,%f",x_,y_));
////                        data.put("comp_loc_map",comp_loc_map);
////                    }
//
//                    comp_color_map = (HashMap< String, String >)persistent_data.get("comp_color_map");
...
////                        System.out.println("Current track: " + data.get("cur_track"));
...
////                            //updateRuleEvidence("Be able to link semaphores to buttons",ruleEvidence);
////                        }
//
//                        if ( data_.contains("conditional")  ) {
//                            analyzer.updateRuleEvidence("Be able to link buttons to direction switches");
//                            //updateRuleEvidence("Be able to link buttons to direction switches",ruleEvidence);
//                        }
//
...
//                    //updateRuleEvidence("Hover over side arrows to see different colored tracks",ruleEvidence);
//
//                    break;
...
//                    //updateRuleEvidence("Use help bar",ruleEvidence);
//                    break;
...
//        s_ = s_ - (Long)all_persistent_data.get(0).data.get("start_time");
//
...
////                    }
////
////                    data.replace("num_dragged",(Integer)data.get("num_dragged") + 1);
////
////                    n = feature_vector.get("total_dragged_components_dist");
////                    feature_vector.replace("total_dragged_components_dist", n + dist);
////                    data.replace("dragging",false);
...
////                    if (id_coord.p1 != null && id_coord.p2 != null) {
////                        dist = Math.sqrt(Math.pow((fd_coord.p1 - id_coord.p1), 2.0) + Math.pow((fd_coord.p2 - id_coord.p2), 2.0));
////                        ruleEvidence.replace("Drag objects",1.0);
////                    } else {
////                        dist = 0.0;
////                    }
////
