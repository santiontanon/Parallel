...
public class AccuracyExperiments9DashMain {
    ...
    public static void main(String [] args) throws Exception {
        ...
        String directory_name = "accuracy-results-9-dash/";
        ...
        String testing_data_relative_path = "../9-dash-data/9-dash-dataset";
            ...
            for (int utf : skill_vector_update_technique_flags) {
                if (utf == 0 || utf == 1) {
                    for (int i = 0; i < machine_learning_algorithms.length; i++) {
                        ...
                        SimulationAccuracy9Dash sim = new SimulationAccuracy9Dash(classifier, time, utf, training_data_relative_path, testing_data_relative_path);
                        sim.execute();
//                        System.exit(1);
                    ...
                    SimulationAccuracy9Dash sim = new SimulationAccuracy9Dash(new BayesNet(), time, utf, training_data_relative_path, testing_data_relative_path);
                    sim.execute();
//                    System.exit(1);
